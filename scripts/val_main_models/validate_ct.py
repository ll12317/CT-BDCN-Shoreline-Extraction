# -*- coding: utf-8 -*-
"""
Pure validation script for EdgeEnhancedSegNet.

This script only handles validation:
1. Load validation images and masks.
...
The network definition is intentionally not included here. Keep the model architecture
in edge_enhanced_segnet.py and import EdgeEnhancedSegNet from that file.
"""
...
BEST_WEIGHT_PATH = RESULT_DIR / "edge_best2.pth"

PRED_DIR = RESULT_DIR / "edge_val_preds_0.2"
CMP_DIR = RESULT_DIR / "edge_val_compare_0.2"
EDGE_PRED_DIR = RESULT_DIR / "edge_val_edgepreds_0.2"
METRICS_TXT = RESULT_DIR / "edge_metrics_val.txt"
...
try:
    from edge_enhanced_segnet import EdgeEnhancedSegNet
except ImportError as exc:
    raise ImportError(
        "Cannot import EdgeEnhancedSegNet. "
        "Please put the network definition in edge_enhanced_segnet.py "
...
# ================== Model builder ==================
def build_model():
    """Build the same EdgeEnhancedSegNet architecture used during training."""
    model = EdgeEnhancedSegNet(
        in_channels=3,
        num_classes=1,
        embed_dim=128,
        num_heads=4,
...
# ================== Validation ==================
def evaluate():
    print("\n=== Starting EdgeEnhancedSegNet validation ===")
