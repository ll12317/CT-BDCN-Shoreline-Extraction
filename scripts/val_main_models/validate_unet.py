# -*- coding: utf-8 -*-
"""
Pure validation script for U-Net.

This script loads validation data, loads the trained U-Net checkpoint, saves
predictions/comparison panels, and computes full-image and edge-band metrics.
The network definition is not included here and is imported from u_net.py.
"""
...
BEST_WEIGHT_PATH = RESULT_DIR / "u_net_best.pth"

PRED_DIR = RESULT_DIR / "u_net_val_preds"
CMP_DIR = RESULT_DIR / "u_net_val_compare"
METRICS_TXT = RESULT_DIR / "u_net_metrics_val.txt"
...
try:
    ...
    raise ImportError(
        "Cannot import UNet. Please put u_net.py in the same directory as this validation script."
    ) from exc
...
def evaluate():
    ...
    print("\n=== U-Net segmentation metrics on validation set ===")
    print(f"PA        = {pa:.4f}")
