# -*- coding: utf-8 -*-
"""
Pure validation script for EdgeEnhancedSegNet_ASPPEdge.
...
same directory as this script and make sure it exposes EdgeEnhancedSegNet_ASPPEdge.
"""
...
BEST_WEIGHT_PATH = OUT_ROOT / "cntrans+deeplabv3+_best.pth"

PRED_DIR = OUT_ROOT / "cntrans+deeplabv3+_val_preds"
CMP_DIR = OUT_ROOT / "cntrans+deeplabv3+_val_compare"
EDGE_PRED_DIR = OUT_ROOT / "cntrans+deeplabv3+_val_edgepreds"
METRICS_TXT = OUT_ROOT / "cntrans+deeplabv3+_metrics_val.txt"
...
from edge_enhanced_segnet_aspp_edge import EdgeEnhancedSegNet_ASPPEdge
...
def build_model() -> torch.nn.Module:
    ...
    model = EdgeEnhancedSegNet_ASPPEdge(
        in_channels=3,
        num_classes=1,
        embed_dim=128,
        num_heads=4,
